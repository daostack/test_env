...
async function deployDaos() {
  ...
  /**
   * CREATE Common DAO rc.32
   */
  expectedName = 'Common DAO'
  console.log(`Creating Common DAO - version rc.32`);
  options.arcVersion = '0.1.1-rc.13'
  const { createCommon } = require('./createCommonDAO')
  await createCommon()
